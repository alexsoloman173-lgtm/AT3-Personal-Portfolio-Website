---
name: meta-skills
description: "Generate production-grade SKILL documents for LLMs that are deterministic, auditable, and schema-first. Use when authoring a new SKILL specification, converting informal instructions into a structured skill, or auditing an existing SKILL document for compliance."
---
