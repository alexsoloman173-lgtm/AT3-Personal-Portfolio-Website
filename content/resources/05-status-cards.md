...
title: Status Cards
slug: status-cards
modal_title: Resource 5: Status Cards (Formative Assessment Tool)
icon: clipboard-check
summary: Formative assessment tool for classroom feedback.
...
media_download_name: Status Cards PDF
card_class: tall
extra: true
count_id: ref5Count
countable: true
