...
title: Gamification
slug: gamification
modal_title: Gamifying APA7: Learning from the Computer Lab Era
icon: gamepad-2
summary: Browser-based APA7 referencing game inspired by classic computer lab serious games.
image: resources/gamification.png
image_alt: Screenshot of the APA7 gamification challenge resource
link_url: https://alexsoloman173-lgtm.github.io/APA7-challange/
link_text: Open the challenge ->
media_image: resources/gamification.png
media_link: https://alexsoloman173-lgtm.github.io/APA7-challange/
media_link_text: Open APA7 challenge
count_id: ref2Count
countable: false
---

Growing up in the 80's and 90's, I recall with great fondness the educational software of the so-called "computer lab" era. Therefore, for the gamification resource, I chose to follow in the footsteps of classic games such as Word Munchers, Midnight Rescue, and the Oregon Trail to develop a browser-based learning game that helps the player memorize the APA7 reference style. The game, called "APA7 Challenge", can be found at the following URL: [https://alexsoloman173-lgtm.github.io/APA7-challange/](https://alexsoloman173-lgtm.github.io/APA7-challange/)
...
The game itself is built with *Phaser.js*, [Introduction To Phaser.js - GeeksforGeeks](https://www.geeksforgeeks.org/html/introduction-to-phaser-js/), a JavaScript framework for casual and educational games. Not wishing to spend too much time coding it, I received help from *Github's Co-pilot*. The game itself is very basic and can be considered a minimum-viable-product and nothing more. One challenge in the design process was controlling scope: there is always a temptation to add extra mechanics, polish, and features that are fun but pedagogically noisy. My solution was to keep the prototype intentionally constrained and to privilege clarity of the reference-building task over entertainment complexity. While I have no plans to develop it further, I will say that the core gameplay loop seemed to be effective and helped me to consolidate my own memorization of the APA7 format.
